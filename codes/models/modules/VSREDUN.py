...
from models.modules.VSRUN import DownBlock, ForwardConcat
...
class VSRUN(nn.Module):
    ...
    def forward(self, inputs):
        ...
        L2_down = self.fea_L2_down(L1_down)
        L3_down = self.fea_L3_down(L2_down)
        ...
        aligned_fea = self.align_pcd(L1_fea, L2_fea, L3_fea)
        ...
        aligned_fea = self.align_pcd(x_down1, L1_fea, L2_fea)
        ...
        aligned_fea = self.align_pcd(x_head, x_down2, L1_fea)
